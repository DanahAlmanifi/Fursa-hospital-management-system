            ...
            <div className="login-panel">
                <div className="login-card">
                    ...
                    <div className="login-logo">
                        ...
                        <div>
                            <div className="login-brand">Fursa | فرصة</div>
                    ...
                    {!sent ? (
                        <>
                            ...
                            <p className="login-desc">Enter your email to receive a secure link.</p>
                        ...
                        <div className="login-sent">
                            ...
                            <p>We sent a link to <strong>{email}</strong>. Open it to sign in.</p>
